...
def home(request):
    if request.user.is_authenticated:
        ...
        return render(request, 'BMS_app/signin.html')
...
def findbus(request):
    ...
    if request.method == 'POST':
        ...
        if bus_list:
            return render(request, 'BMS_app/list.html', locals())
        else:
            context["error"] = "Sorry no buses availiable"
            return render(request, 'BMS_app/findbus.html', context)
    else:
        return render(request, 'BMS_app/findbus.html')
    ...
    if request.method == 'POST':
        ...
        if bus:
            if bus.rem > int(seats_r):
                ...
                # book.save()
                return render(request, 'BMS_app/bookings.html', locals())
            else:
...
def cancellings(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'BMS_app/error.html', context)
    else:
        return render(request, 'BMS_app/findbus.html')
...
def seebookings(request,new={}):
    ...
    if book_list:
        return render(request, 'BMS_app/booklist.html', locals())
    else:
...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            login(request, user)
            return render(request, 'BMS_app/thank.html')
        else:
            context["error"] = "Provide valid credentials"
            return render(request, 'BMS_app/signup.html', context)
    else:
        return render(request, 'BMS_app/signup.html', context)
...
def signin(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            return render(request, 'BMS_app/success.html', context)
            # return HttpResponseRedirect('success')
        else:
            context["error"] = "Provide valid credentials"
            return render(request, 'BMS_app/signin.html', context)
    else:
